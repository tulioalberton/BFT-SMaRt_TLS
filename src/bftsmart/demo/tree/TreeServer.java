/**
Copyright (c) 2007-2019 Alysson Bessani, Eduardo Alchieri, Paulo Sousa, Tulio A. RIbeiro, and the authors indicated in the @author tags
 ...
 */
public final class TreeServer extends DefaultRecoverable{
    ...
    public TreeServer(int id, int interval, int replySize, int stateSize, boolean context) {
    ...
    public static void main(String[] args){
        if(args.length < 5) {
            System.out.println("Usage: ... TreeServer <processId> <measurement interval> <reply size> <state size> <context?>");
            System.exit(-1);
        }
        ...
        new TreeServer(processId,interval,replySize, stateSize, context);        
    }
